...
class TestDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            ['sku' => 'FER002', 'name' => 'Abono Orgánico 50kg', 'category_id' => $createdCategories['fertilizantes']->id, 'purchase_price' => 40.00, 'sale_price' => 60.00, 'stock' => 20, 'min_stock' => 5, 'unit' => 'bolsa'],
